 ...
 * *
 * *  Revision History:
 * *  $Id: DigitalIn.h,v 1.9 2016/08/09 17:09:44 emrsn\jbeatty Exp $
 * *  $Log: DigitalIn.h,v $
...
#define NR_ENUM_ROC_DIGITAL_IN 8
// Digital Input Device
class CDigitalIn : public CBaseDev
{
private:
  static bool m_bROCIO_DIState[4 * NR_ENUM_ROC_DIGITAL_IN];

public:
  CDigitalIn();   // Default Constructor
  
  ~CDigitalIn();  // Destructor
  ...
  int GetDigitalInStatus(BOOL *pbData);   // Pointer to write status to
