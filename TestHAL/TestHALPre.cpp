...
void TestHeaterCtrl()
{
  static char szHtrDevNames[NR_HTR_CHANNELS][50] = {
    "HTR_CTRL:SLOT_1:HTR_CTRL_1",
    "HTR_CTRL:SLOT_1:HTR_CTRL_2",
    "HTR_CTRL:SLOT_1:HTR_CTRL_3",
    "HTR_CTRL:SLOT_1:HTR_CTRL_4",
  };
...
int TestPreamp(int nPres)
{
  static char szPreDevNames[NR_PRE_CHANNELS][50] = { 
    "PREAMP_STR:SLOT_2:PREAMP_1",
    "PREAMP_STR:SLOT_2:PREAMP_2",
  };
  ...
  unsigned int unPrevBridgeData = 0;
      ...
      //for (int nPres = 0; nPres < 1/*NR_PRE_CHANNELS*/; nPres++)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            DEBUG("%d\n", unBridgeData);
            if (unBridgeData != (unPrevBridgeData + 1))
            {
              printf("Data received out of sequence.\n");
            }
            
            unPrevBridgeData = unBridgeData;
          }
        }
      }
    }
